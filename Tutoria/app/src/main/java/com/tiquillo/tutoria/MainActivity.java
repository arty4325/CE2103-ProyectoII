...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sensorManager != null){
            ...
            Toast.makeText(this, "SensorManagerNotDetected.", Toast.LENGTH_SHORT).show();
        }
    ...
    private void EnviarSensor(String valuex, String valuey, String valuez) {
        textView3.setText("Enviando mensaje\n\nSi ve este texto,\nhay un problema sin resolver");
        new Thread(() -> {
            String a = "";
            try {
                ...
                String message = valuex + " ," +  valuey + " ," + valuez;
                output.printf(message);
                Log.d("ENVIADO", message);
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        if (sensorEvent.sensor.getType() == Sensor.TYPE_ACCELEROMETER){
            // Mandar el mensaje
            EnviarSensor(Float.toString(sensorEvent.values[0]),
