...
void Level2::setValues(int p, int v, int n){
    ...
    connect(movementThirdEnemy, &QTimer::timeout, this, &Level2::MoveThirdEnemy);
    movementThirdEnemy -> setInterval(500);
    movementThirdEnemy -> start();

    movementFourthEnemy = new QTimer(this);
    connect(movementFourthEnemy, &QTimer::timeout, this, &Level2::MoveFourthEnemy);
